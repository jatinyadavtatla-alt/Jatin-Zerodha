            ...
            <div className="row m-5">
                ...
                <div className="col m-3">
                    <p>
                        ...
                        <br/>
                        <br/>
                        <a href="https://rainmatter.com/" target="_blank" style={{textDecoration:"none"}}>Rainmatter</a>
                        ...
                        <a href="#" target="_blank" style={{textDecoration:"none"}}> blog </a>
                        or see what the media is 
                        <a href="#"  style={{textDecoration:"none"}}> saying about </a>
                        saying about us or learn more about our business and product 
                        <a href="#" target="_blank" style={{textDecoration:"none"}}>  philosophies </a>
                        .
                    </p>
                </div>
            </div>
